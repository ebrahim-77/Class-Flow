...
export const EditScheduleModal: React.FC<EditScheduleModalProps> = ({
  ...
  const [editType, setEditType] = useState<"update" | "reschedule" | "cancel">(
    "update",
  );
          ...
          <div className="w-full max-w-md max-h-[90vh] overflow-y-auto rounded-lg bg-white shadow-xl">
            <div className="sticky top-0 flex items-center justify-between border-b px-6 py-4 bg-white">
              <h2 className="text-lg font-semibold text-gray-900">
                Edit Class: {schedule.courseName}
              </h2>
              <button
                onClick={onClose}
            ...
            <form onSubmit={handleSubmit} className="space-y-6 p-6">
                ...
                <div className="space-y-2">
                  ...
                  <label className="flex items-center space-x-3 cursor-pointer">
                    <input
                      ...
                      onChange={(e) =>
                        setEditType(e.target.value as "reschedule")
                      }
                      className="w-4 h-4"
                    />
                ...
                <div>
                  ...
                  <div className="mt-3 p-3 bg-red-50 border border-red-200 rounded-lg">
                    <p className="text-sm text-red-700">
                      ⚠️ This class will be marked as cancelled and students
                      will be notified.
                    </p>
                  </div>
                </div>
              ...
              {/* Buttons - REMOVE sticky, negative margins, and bg-white */}
<div className="flex gap-3 pt-4 border-t border-gray-100">
  ...
  <button
    ...
    disabled={isSubmitting}
    style={{
      backgroundColor: editType === 'cancel' ? '#dc2626' : '#2563eb',
      color: '#ffffff',
    }}
    className="flex-1 px-4 py-2 rounded-lg font-medium transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
  >
